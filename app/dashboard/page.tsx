...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    // ✅ FIX: Listen to auth changes (important for Google login)
    const {
      data: { subscription },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 flex flex-col justify-center">
            ...
            <p className="text-gray-500 mt-1">
              Your e-commerce empire is looking strong today.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-indigo-600 to-blue-700 rounded-2xl p-5 text-white shadow-lg relative overflow-hidden">
            ...
            <p className="text-xs text-blue-100 mb-3 italic">
              "Try using A+ Content focusing on 'Durability' for your top SKU this week."
            </p>
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <ServiceCard title="Account Management" desc="Full handling for Amazon/Flipkart." icon={<LayoutDashboard className="w-4 h-4"/>}/>
                <ServiceCard title="A+ Content Design" desc="High-conversion visual storytelling." icon={<Sparkles className="w-4 h-4"/>}/>
                <ServiceCard title="Ads Optimization" desc="Lower your ACOS with expert PPC." icon={<LineChart className="w-4 h-4"/>}/>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {(query ? filteredTools : TOOLS.slice(0, 8)).map(tool => (
                  <Link key={tool.slug} href={`/tools/${tool.slug}`} className="group bg-white p-4 rounded-xl border hover:border-blue-500 hover:shadow-md transition relative">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl border p-5 shadow-sm">
              ...
              <div className="space-y-4">
                <BlogItem title="Flipkart Big Billion Days Prep" date="2 mins read"/>
                <BlogItem title="New GST rules for E-commerce" date="5 mins read"/>
                <BlogItem title="Mastering Amazon PPC in 2026" date="8 mins read"/>
              </div>
            ...
            <div className="bg-gray-900 rounded-2xl p-5 text-white shadow-xl">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[10px] text-gray-500 italic">
                  You're in the top 15% of active sellers this month!
                </p>
              </div>
            </div>
          </div>
